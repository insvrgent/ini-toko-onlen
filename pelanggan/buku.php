        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div class="col">
            <div class="card shadow-sm">
                <img src="../petugas/foto/<?=$data_buku['foto']?>" class="bd-placeholder-img card-img-top"  xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <a href="pinjam_buku.php?id_buku=<?=$data_buku['id_buku']?>" type="button" class="btn btn-sm btn-outline-secondary">Beli</a><small class="text-muted"><?=formatRp($data_buku['harga'])?></small>
                    </div>
                    <small class="text-muted"><?=$data['nama_petugas']?></small>
                </div>
                </div>
            </div>
            </div>
